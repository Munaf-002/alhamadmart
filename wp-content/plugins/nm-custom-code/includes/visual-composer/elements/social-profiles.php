	...
	vc_map( array(
	   ...
	   'params'			=> array(
            ...
            array(
				'type' 			=> 'textfield',
				'heading' 		=> 'Messenger',
				'param_name' 	=> 'social_profile_messenger',
				'description'	=> esc_html__( 'Enter your Messenger URL.', 'nm-framework-admin' )
			),
            array(
				'type' 			=> 'textfield',
				'heading' 		=> 'MixCloud',
            ...
            array(
				'type' 			=> 'textfield',
				'heading' 		=> 'Viber',
				'param_name' 	=> 'social_profile_viber',
				'description'	=> esc_html__( 'Enter your Viber URL.', 'nm-framework-admin' )
			),
			array(
				'type' 			=> 'textfield',
				'heading' 		=> 'Vimeo',
